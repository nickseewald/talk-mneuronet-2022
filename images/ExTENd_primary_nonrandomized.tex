...
%			font=\footnotesize,
		...
		\matrix[row sep=-2mm,column sep=12mm] { %
			...
			& & & & \node (D-I) [treatment,highlighttx] {naltrexone + \\ telehealth}; & \node (sbgp2) [subgroup] {B};\\
			& \node (A-I) [treatment] {behavioral intervention + \\ medical management + \\ stringent non-response}; & & & & \\[-6mm]
			& & & & \node (E-I) [treatment,highlighttx2] {behavioral intervention + \\ medical management + \\ placebo}; & \node (sbgp3) [subgroup] {C}; \\
			& & \node (b2-I) [blank] {}; & \node (R3-I) [randomize, rerand] {R}; & & \\
			& & & & \node (F-I) [treatment,highlighttx2] {behavioral intervention + \\ medical management + \\ naltrexone}; & \node (sbgp4) [subgroup] {D}; \\[2mm]
			\node (R1-I) [randomize] {R}; & & & & & \\[2mm]
			...
			& \node (B-I) [treatment] {naltrexone + \\ medical management + \\ lenient non-response}; & & & & \\[-2mm]
			...
			& & & & \node (J-I) [treatment,highlighttx2] {behavioral intervention + \\ medical management + \\ placebo}; & \node (sbgp8) [subgroup] {H};\\
		};
...
%		\draw[dashed,lightgray] (time2.north west) --++(90:33cm);
		...
		\draw[subsetarrow,highlightline] (C-I.east) -- (sbgp1.west);
		\draw[subsetarrow,highlightline] (D-I.east) -- (sbgp2.west);
		\draw[subsetarrow,highlightline2] (E-I.east) -- (sbgp3.west);
		\draw[subsetarrow,highlightline2] (F-I.east) -- (sbgp4.west);
		\draw[subsetarrow,highlightline] (G-I.east) -- (sbgp5.west);
		\draw[subsetarrow,highlightline] (H-I.east) -- (sbgp6.west);
		\draw[subsetarrow,highlightline2]  (I-I.east) -- (sbgp7.west);
		\draw[subsetarrow,highlightline2] (J-I.east) -- (sbgp8.west);
