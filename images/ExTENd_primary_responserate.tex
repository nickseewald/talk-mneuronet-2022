...
%			font=\footnotesize,
		...
		\matrix[row sep=-2mm,column sep=12mm] { %
			...
			& \node (A-I) [treatment,highlighttx] {behavioral intervention + \\ medical management + \\ stringent non-response}; & & & & \\[-6mm]
			...
			& \node (B-I) [treatment,highlighttx2] {naltrexone + \\ medical management + \\ lenient non-response}; & & & & \\[-2mm]
			& & & & \node (I-I) [treatment] {behavioral intervention + \\ medical management + \\ placebo}; & \node (sbgp7) [subgroup] {G}; \\
			& & \node (b4-I) [blank] {}; & \node (R5-I) [randomize, rerand] {R}; & & \\
			& & & & \node (J-I) [treatment] {behavioral intervention + \\ medical management + \\ placebo}; & \node (sbgp8) [subgroup] {H};\\
		};
...
%		\draw[dashed,lightgray] (time2.north west) --++(90:33cm);
		...
		\draw[dashed,black,ultra thick] ($(R5-I.south)+(0,-1)$) -- ($(R2-I.north) + (0,1.5)$);		
